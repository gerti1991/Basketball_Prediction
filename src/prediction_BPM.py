...
try:
    ...
    def predict_match(FINAL_2, league, season, home_team, away_team, Book_Odds_home, Book_Odds_away):
        team_1 = filter_dataframe(FINAL_2, league, season, home_team).sort_values(by='% MIN', ascending=False).head(10)
        team_2 = filter_dataframe(FINAL_2, league, season, away_team).sort_values(by='% MIN', ascending=False).head(10)
