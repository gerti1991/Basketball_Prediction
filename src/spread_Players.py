...
try:
    ...
    FINAL_temp_2 = merge_rows(FINAL,FINAL_temp_2,Row_to_add=['BPM','trader rating'])
    ...
    FINAL_temp_2['BPM'] = np.where(pd.notna(FINAL_temp_2['trader rating']), FINAL_temp_2['trader rating'], FINAL_temp_2['BPM'])
    FINAL_2 = FINAL_temp_2[['League','Season','Team','Player','Position','% MIN','Estimated Possessions','Possessions/Min','BPM']]
